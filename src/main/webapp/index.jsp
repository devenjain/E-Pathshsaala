...
<body>
	...
	<section class="vh-100">
			...
			<div
				...
				<div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
					<form action="auth" method="post">
						...
						<select class="form-select" aria-label="Default select example" name="whoIs">
		...
		<div
			...
			<!-- Copyright -->
			<div class="text-white mb-3 mb-md-0"><center>Copyright © 2022. E-Pathshsaal, All
				rights reserved.</center></div>
			<!-- Copyright -->
