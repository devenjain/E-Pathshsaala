	...
	<div class="body-container12">
		<form action="insertFaculty" method="post">
			<div class="container12">
				...
				<input type="text" class="form-control" name="ffname" placeholder="Firstname" size="15" value="${fname}"
					required />

				<label> Lastname : </label> <font color="RED"> ${lnameError } </font> 
				<input type="text" name="flname" class="form-control" placeholder="Lastname" size="15" value="${lname}"
					required />
				...
				<div>
					...
					<div class="form-check form-check-inline mb-0 me-4">
						<input class="form-check-input" type="radio"
							name="fgender" id="femaleGender" value="Female" /> <label
							class="form-check-label" for="femaleGender">Female</label>
					</div>

					<div class="form-check form-check-inline mb-0 me-4">
						<input class="form-check-input" type="radio"
							name="fgender" id="maleGender" value="Male" /> <label
							class="form-check-label" for="maleGender">Male</label>
					</div>

					<div class="form-check form-check-inline mb-0">
						<input class="form-check-input" type="radio"
							name="fgender" id="otherGender" value="Other" /> <label
...
<textarea cols="80" rows="5" placeholder="Current Address" value="address" required>   -->
				...
				<label for="email"><b>Email</b></label> &nbsp;&nbsp; <font
					color="RED">${emailError }</font> <input type="text" class="form-control" 
					placeholder="Enter Email" name="femail" value="${email}" required>
