											...
											<div class="mb-4">
												<div class="form-outline">
													<input type="number" id="form3Example1m"
														class="form-control form-control-lg" name="sid" value="${bean.sid }"
												...
												<div class="mb-4">
													<div class="form-outline">
														<input type="text" id="form3Example1m"
															class="form-control form-control-lg" name="sfname" value="${bean.sfname }"
												...
												<div class="mb-4">
													<div class="form-outline">
														<input type="text" id="form3Example1n"
															class="form-control form-control-lg" name="slname" value="${bean.slname }"
												...
												<div class="mb-4">
													<div class="form-outline">
														<input type="text" id="form3Example1n1"
															class="form-control form-control-lg" name="smname" value="${bean.smname }"
                                        ...
                                        <div class="col-md-6 mb-4">
											...
											<div class="form-outline mb-4">
												<input type="text" id="form3Example9"
													class="form-control form-control-lg" name="sphone" value="${bean.sphone }"
											...
											<div class="form-outline mb-4">
												<input type="text" id="form3Example90"
													class="form-control form-control-lg" name="semail" value="${bean.semail }"
													placeholder="Email" />
